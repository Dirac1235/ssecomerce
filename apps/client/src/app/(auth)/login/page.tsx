...
function Login() {
  ...
  return (
    ...
    >
      <div className="py-48  " style={{ paddingLeft: "60rem" }}>
        <Form {...form}>
          <form
          ...
          >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      className="w-96 border-b-black mb-2"
                      placeholder=""
                      {...field}
                    />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      className="w-96 border-b-black text-slate-900"
                      placeholder=""
                      type="password"
                      {...field}
                    />
            ...
            <div className="py-5 text-sm">
              ...
              <Link href="/register" className="underline text-pink-700 ml-2 ">
                register here
              </Link>
            </div>
          </form>
